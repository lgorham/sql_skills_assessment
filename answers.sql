...
==========
13
# This wouldn't accept my answer, because GTO is the stored results was above Grand Prix
# and I couldn't figure out a way to change all capital letters to go before all lowercase letters
...
SELECT b.name, 
      ...
      m.year, 
      b.discontinued,
      m.year - b.discontinued AS years_until_brand_discontinued
FROM models AS m
...
#also tried ORDER BY b.name, ASCII(m.name), m.year
#and ORDER BY b.name, m.name ASC/DSC, m.year
